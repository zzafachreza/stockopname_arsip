    ...
    return (
        <SafeAreaView style={{
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{
                ...
                <MyInput label="ID" iconname="at-outline" value={kirim.username} onChangeText={x => setKirim({ ...kirim, username: x })} />
                <MyGap jarak={10} />
                ...
                <MyGap jarak={10} />
                <MyInput label="Jabatan" iconname="ribbon-outline" value={kirim.jabatan} onChangeText={x => setKirim({ ...kirim, jabatan: x })} />
                <MyGap jarak={10} />
